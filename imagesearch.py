...
"""
Searches for an image on the screen and names the number of occurrences.
...
def imagesearch_name(image,usage, precision=0.9):
    
    #img_rgb = pyautogui.screenshot()
    if usage == 'pool_box':
        img_rgb = region_grabber((450, 950, 1500, 1115))
    else :
        img_rgb = region_grabber((0, 0, 1920, 1080))
    if is_retina:
